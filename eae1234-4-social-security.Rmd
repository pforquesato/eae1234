...
date: "Topic 4: Social Security<br/>2026/2"
output:
...
```{r, echo=FALSE, out.width = '90%'}
knitr::include_graphics("figs/resultado_rgps.png")
```

Over the last two decaded the "social security deficit" has increased steadily, up to the 2019 Retirement Reform [[Observatório Fiscal IBRE]](https://observatorio-politica-fiscal.ibre.fgv.br/politica-economica/outros/mudanca-das-metas-e-o-desafio-da-sustentabilidade-fiscal-brasileira)
