...
date: "Topic 9: Transfers and social assistance<br/>2026/2"
output:
...
```{r, echo=FALSE, out.width = '90%', fig.align='center'}
knitr::include_graphics("figs/eae1234-9-11.png")
```

Extreme poverty fell sharply in the 2000s, from one quarter of Brazilians (!!) in 2000 to 7% in 2013, probably mostly due to PBF, and now fallen again in the 2020s to 4.8% in 2024 (and 3.5% in 2025) `r Citep(myBib, "hecksher2025pobreza")`

---
class: middle

```{r, echo=FALSE, out.width = '90%', fig.align='center'}
knitr::include_graphics("figs/eae1234-9-12.png")
```

Poverty in Brazil also fell from 60% of Brazilians in 2000 to half of this amount ten years later, and nowadays a quarter of Brazilians are still poor `r Citep(myBib, "hecksher2025pobreza")`
...
```{r, echo=FALSE, out.width = '90%', fig.align='center'}
knitr::include_graphics("figs/eae1234-9-13.png")
```

Transfer policies have a significant effect in reducing Gini inequality... `r Citep(myBib, "hecksher2025pobreza")`
...
```{r, echo=FALSE, out.width = '90%', fig.align='center'}
knitr::include_graphics("figs/eae1234-9-14.png")
```

... but much larger effect in reducing poverty &mdash; without them the extreme poverty rate would be 3 times larger  `r Citep(myBib, "hecksher2025pobreza")`
...
```{r, echo=FALSE, out.width = '100%', fig.align='center'}
knitr::include_graphics("figs/eae1234-9-15.png")
```

Using a 2012 expansion, `r Citep(myBib, "best2026cash")` find evidence that PBF *increases* labor supply through a "productive inclusion" effect &mdash; recipients spend more on medicine (and presumably better nutrition) and this increased health allows them to find employment 
...
Using a 2012 expansion, `r Citep(myBib, "best2026cash")`
