...
date: "Topic 12: Corporate Taxes<br/>2026/2"
output:
...
knitr::include_graphics("figs/eae1234-12-2.png")
```

In terms of employment, however, this effect is less pronounced, and especially in Latin America, where small (and unproductive) firms dominate &mdash; while in the EU 65% of workers are employed in companies with 11+ employees, in LA 59% work at companies with less than 4 people `r Citep(myBib, "eslava2025businesses")` 
...
knitr::include_graphics("figs/eae1234-12-3.png")
```

In fact, `r Citep(myBib, "nallareddy2022corporate")` find that a 1 p.p. decrease in state corporate taxes in the USA causes a 0.9 p.p. increase in the share of the top 1% in the income &mdash; so corporate tax cuts would be responsible for 7.4% of the (6.1 p.p.) increase in top 1% share of income since the 90s

---
class: middle

```{r, echo=FALSE, out.width = '80%', fig.align='center'}
knitr::include_graphics("figs/eae1234-12-4.png")
```

On the same direction, `r Citep(myBib, "kennedy2026corporate")` investigate the incidence effects of the 2017 Tax Cuts and Jobs Act (TCJA), and they find that it led to increases in investment, capital, employment, and payroll, but...
...
```{r, echo=FALSE, out.width = '100%', fig.align='center'}
knitr::include_graphics("figs/eae1234-12-5.png")
```

A large part of the gains are reflected in increased corporate after-tax income and dividend payouts `r Citep(myBib, "kennedy2026corporate")`...
...
```{r, echo=FALSE, out.width = '80%', fig.align='center'}
knitr::include_graphics("figs/eae1234-12-6.png")
```

And even the payroll increases are heavily concentrated on top: overall, the top 10% receive 87% of the TCJA private gains `r Citep(myBib, "kennedy2026corporate")`

---
class: middle

```{r, echo=FALSE, out.width = '90%', fig.align='center'}
knitr::include_graphics("figs/eae1234-12-1.png")
```

Since 1990, the value of US corporate equity has tripled, increasing at a rate of 7.2% per year &mdash; the authors find that 40% of this increase is a reallocation of labor compensation to shareholders, as opposite to only 25% due to economic growth `r Citep(myBib, "greenwald2025wealth")`
...
`r Citep(myBib, "torslov2018missing")` estimate that 14% of corporate tax revenue in Brazil is evaded by using tax havens (23% in the US) [[World missing profits database]](https://missingprofits.world/) &mdash; 18% of all profits made by American companies (inside or outside the US) are now realized in tax havens, and they pay almost no taxes (on average 3%) [[Our article in Valor]](https://www.pedroforquesato.com/files/paraisos.jpeg)

More recently, `r Citep(myBib, "fuest2025global")` estimate a global loss of corporate tax revenue of €162 billion (12% of the total) due to MNE profit shifting
...
PrintBibliography(myBib, start=21)
```
</small>
