...
Whether private provision might be more efficient depends on the characteristics of the market: whether public-private contracts can be bidding (which depends on **contractibility**) and whether the advantages of the market can shine through large innovation potential and competition `r Citep(myBib, "campos2021ways")`
