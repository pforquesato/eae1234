...
date: "Topic 6: Tax incidence and deadweight loss<br/>2026/2"
output:
...
```{r, echo=FALSE, out.width = '85%', fig.align='center'}
knitr::include_graphics("figs/eae1234-6-1.jpg")
```

On the other hand, in non-competitive markets the tax can be amplified by the firm's **mark-up**, leading to pass-throughs *higher than one* `r Citep(myBib, "flaaen2025pays")` 
