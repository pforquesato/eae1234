...
The main way of reducing socioeconomic inequalities is the progressive taxation system of labor income and transfers, since labor income accounts for around 3/4 of the national product
...
In 1850, capital's share of national income was nearly 50%, but it has dropped since then, and today it accounts for only 25-30% of GDP, the complement being the labor share `r Citep(myBib, "piketty2014capital")`
...
Brazilian wealth is extremely unequal distributed (even in international comparison): the richest 10% have around 3/4 of Brazilian wealth, and the richest 1% have half &mdash; as it is common internationally, the poorest 50% have zero wealth [(WID)](https://wid.world/country/brazil/)
...
Brazil is among only 6 countries in the world where the poorest 80% have less wealth than the richest 0,001% (1/100.000), in other words, 2.000 people (the size of the FEA student body) have more wealth than 160 million Brazilians together [(WID and @rubenbmathisen)](https://twitter.com/rubenbmathisen/status/1508148771225485316)
...
In the US, the wealth of the 90% grew until the 80s with incentives for homeownership, but it has dropped (relatively) since then due to income and savings inequality, besides tax reductions &mdash; and this movement was mirrored by doubling the proportion of the richest 0,1%, which today has 20% of that country's wealth `r Citep(myBib, "piketty2018distributional")`
...
Another way to look at wealth inequality is the Forbes 400 richest list: since 1982, their wealth has tripled, surpassing 3% of the total American wealth &mdash; 3% of wealth for (nearly) 1-in-1-million (Saez)
...
While only 10% of income for 90% of the bottom comes from capital, 60% of income of the richest 1% and 70% of the 0,1% comes from this factor of production (or at least it is reported as it): taxing labor has limited redistribution capacity in these groups `r Citep(myBib, "piketty2018distributional")`
...
(iv) **Property tax:** There is the IPVA, state tax at a rate (SP) of 4% of the car (2% others) and IPTU, which is a municipal tax that in São Paulo varies from 0-1,6% of the property value (progressive rate)

(v) **Wealth tax:** levied on people's total net worth; it exists in only a few countries (not in Brazil)

At this end of the discipline, we will focus entirely on the capital taxation: this week we will study (ii), the following week (iii)-(v), and on the last week, topic (i)
...
Individuals live 2 periods, work $l$ in the first one and do not work in the second one (retirement) and consume $c_1$ in the first and $c_2$ in the second: $$U(c_1, c_2, l) = u(c_1, l) + \beta u(c_2)$$

Then the saving (always in period 1) is $s = wl - c_1$, and consumption as $t=2$ will be $c_2 = (1 + r)s$, which $rs$ is the capital income
...
If $\beta = 1/(1 + r)$ (which will occur in equilibrium in complete and frictionless markets), then individuals *smooth consumption perfectly* throughout the life-cycle (**life-cycle hypothesis**)

The life-cycle hypothesis is: (i) disproved by the data; and (ii) very important in macro, because it is a necessary condition for important theories, such as *Ricardian equivalence*
