...
date: "Topic 10: Taxation on savings<br/>2026/2"
output:
...
knitr::include_graphics("figs/eae1234-10-1.png")
```

More recent calculations of the labor share indicate it has been steadily decreasing since WW2 (in some specifications since the 80s), falling about 8-10 p.p.s since the Great Depression `r Citep(myBib, "karabarbounis2024perspectives")`
...
And this is problematic because during the past 40 years globally the tax rate on capital income (in blue) has decreased significantly (dashed is for corporate profits), while the labor tax rate (in red) remained mostly constant... `r Citep(myBib, "bachas2022capital")`
