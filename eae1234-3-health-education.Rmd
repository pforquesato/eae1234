...
knitr::include_graphics("figs/eae1234-3-4.png")
```

In Brazil, outsourcing hospitals to non-profits increases hospital productivity by 35% (higher turnover and lower length of stay), with no negative effects on quality &mdash; they find exit of less productive doctors, hiring of more specialists with more flexible contracts  `r Citep(myBib, "coube2025public")`

---
class: middle

```{r, echo=FALSE, out.width = '100%', fig.align='center'}
knitr::include_graphics("figs/eae1234-3-3.png")
```

On the population level, this increase in hospital access (over 18%) leads to a 3% decrease in mortality at home (by people that presumably didn't have access before), not at hospitals `r Citep(myBib, "coube2025public")`
...
```{r, echo=FALSE, out.width = '100%', fig.align='center'}
knitr::include_graphics("figs/eae1234-3-5.png")
```

Another evidence against the **signaling** theory (and in favor of human capital) is on grade inflation &mdash; having an "easier" teacher in high school lowers future test scores, SAT scores, chance of completing a BA degree, and future employment and earnings: a PV cost of over 200k dollars (!)
...
```{r, echo=FALSE, out.width = '100%', fig.align='center'}
knitr::include_graphics("figs/eae1234-3-7.png")
```

We cannot discuss higher education nowadays without talking about online education &mdash; while it represented 17% of university enrollment in 2010, it rose to 44% in 2019 and basically 2/3 of enrollment post-pandemic, almost all of it in the private sector `r Citep(myBib, "barahona2025effects")`

---
class: middle

```{r, echo=FALSE, out.width = '100%', fig.align='center'}
knitr::include_graphics("figs/eae1234-3-6.png")
```

While this expansion did raise access to higher education, it did so while generating lower value added (online education leads to a smaller increase in post graduation wages) &mdash; since it is cheaper and more convenient, OE leads to a increase of 14% in overall HE enrollment but a decrease of 33% in (higher value) in-person courses `r Citep(myBib, "barahona2025effects")`
