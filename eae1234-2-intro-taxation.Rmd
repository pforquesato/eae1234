...
date: "Topic 2: Introduction to taxation<br/>2024/2"
output:
...
2. Some *taxes on consumption*: IPI, Cofins, IOF, etc, which represent 4.62% of GDP (all disappearing in place of *Contribuição sobre Bens e Serviços*, CBS, and a special tax *Imposto Seletivo*, IS, on *sin goods*)
...
State revenue is almost entirely value added taxes (ICMS, 6.76% of GDP, with the tax reform will become *Imposto sobre Bens e Serviços*, IBS), but also has a tax on inheritance (ITCMD, 0.12% of GDP) and on automobiles (IPVA, 0.73%)
...
Since then, the tax burden has remained constant in proportion to GDP. From 33% collected by the Brazilian government, 2/3 are collected by the federal government, a quarter by the state, and less than 10% by the municipalities [[Boletim CTB 2023]](https://sisweb.tesouro.gov.br/apex/f?p=2501:9::::9:P9_ID_PUBLICACAO:46589) 
