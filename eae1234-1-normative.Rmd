...
date: "Topic 1: Normative Economics<br/>2026/2"
output:
...
Governments intervene in the *"free markets"* in a variety of ways in modern economies:

1. Regulating activities and whole sectors (**regulation/IO**)
2. Acting directly to provide public goods or correct externalities
3. Governments distribute income from some agents to others, affecting the *inequality* of resources in the economy
4. Policy of business cycles and public debt (**macroeconomics**)
...
Gruber puts forth a four question framework to assess government intervention in the economy:

1. *Should* the government intervene in the economy? (**normative**)
2. *How* the government *should* intervene? (**normative**)
3. What is the *effect* of these interventions on society? (**positive**)
4. How does the government *actually* intervene, and why might it differ from [2]? (**positive**)

---
class: middle
## 1. When should the government intervene?

*Traditional* economics dictates that the role of governmental intervention is *only* to solve **market failures** &mdash; the most well known are *externalities* and *public goods*
...
The modern view is that besides correcting market failures, taxation and government policies are the main tool to **reduce inequalities**
...
knitr::include_graphics("figs/eae1234-1-21.png")
```

Starting from a Gini coefficient of 0.61 in 1996, inequality has decreased steadily since then, to about 10 p.p. lower nowadays &mdash; but this change is mostly a redistribution outside of the top 1%, whose influence hasn't decreased `r Citep(myBib, "hecksher2025pobreza")`
...
```{r, echo=FALSE, out.width = '90%', fig.align="center"}
knitr::include_graphics("figs/eae1234-1-22.png")
```

The Palma ratio, top 10/bottom 40, also decreased from 6.4 times larger (while being 4x less people) in 1995 to "only" 3.5 times more 30 years later `r Citep(myBib, "hecksher2025pobreza")`
...
knitr::include_graphics("figs/eae1234-1-14.png")
```

This is the **Great Gatsby curve**: internationally, countries with higher inequality also exhibit lower income mobility &mdash; and contrary to common belief, the United States ("the land of opportunities") is one of the lowest mobility countries among the advanced economies `r Citep(myBib, "autor2014skills")`
...
spectator would examine it. If, upon placing ourselves in his situation, we thoroughly enter into all the passions and motives which influenced it, we approve of it, by sympathy with the approbation of this supposed equitable judge. If otherwise, we enter into his disapprobation, and condemn it.
...
A historical attempt to solve this issue with normative economics was the 2nd FTWE: we can separate the efficiency problem from the equality problem
...
There is a **trade-off between efficiency and equality**: it is not possible to evaluate public policies by separating the efficiency discussion ("economics") from the equality discussion ("political philosophy")
...
The need to assist policy-makers in practical policy decisions has generated more applied methods of normative analysis &mdash; but conceptual understanding is important to comprehend its limitations
...
Then the opportunity cost is only R$1.2k! If similar workers are willing to work (in the private sector) for that wage, then that is their marginal utility cost of working: what the *society* loses by using that labor
...
The opportunity cost of using social savings for a government project is the rate of return on that savings in the private sector *before taxes* (or the cost of debt financing if financed by public debt)
...
**If** the labor market is perfectly competitive and **if** the worker freely chooses the hours worked *and* the work is not (particularly) unpleasant, then they will choose to work until the wage equals his willingness to pay for leisure
...
The natural solution for those who has studied microeconomics is to use **revealed preference**: people reveal their value of time by their *economic choices* when they choose to pay money to save them time

For example, the market price of housing (the manner how apartments closer to city center are more expensive) reveals the society's willingness to pay for taking longer to get to work

Comparing the line at gas stations with and without a price cap, `r Citep(myBib, "deacon1985rationing")` estimate that Americans are willing to wait 15 minutes to save on average US$5, which is close to the US average wage (back then) of US$20 an hour
...
Also, less global warning 100 years from now will not affect the same people who pay the costs today, but their grandchildren or great-grandchildren (and if we assume the economy will grow during the next 100 years, they will be significantly richer than the people today)
...
```{r, echo=FALSE, out.width = '60%', fig.align='center'}
knitr::include_graphics("figs/eae1234-1-9.png")
```

In LabPub, we evaluated the **marginal value of public funds** for Programa Bolsa Família: the willingness to pay to receive R$1 of PBF is R$1.52 &mdash; and 33% of the cost returns to the government due to higher future taxes (due to higher economic activity and children's education), a MVPF of 2.29

---
class: middle

```{r, echo=FALSE, out.width = '80%', fig.align='center'}
knitr::include_graphics("figs/eae1234-1-10.png")
```

While for the Estratégia Saúde da Família, almost all of the willingness to pay is due to the *value of a statistical life* (lower mortality), but which is very sizable, generating a MVPF of 3.76
...
<!-- These slides were translated to English by the PUB scholarship holder Chen Xiaoting (USP Language major), I thank her for her effort! -->

<!-- All course materials are in English. Lectures are also in English, but questions in Portuguese are allowed &mdash; any words you do not know, feel free to ask (maybe I even made them up `r emo::ji("flushed")`) -->

<!-- Exams can be written in Portuguese, but the exercise list and essays must be delivered in English &mdash; presentations should also be in English so everyone can understand, but we can talk personally if anyone feels uncomfortable -->
...
<!-- The most important words in economics studies for undergraduate students around the world &mdash; almost all of the main ones are studied in this course  -->
